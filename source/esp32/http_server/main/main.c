...
#define CONFIG_WIFI_SSID   "TMT"
#define CONFIG_WIFI_PASSWD "tmt123123@"
...
static void httpd_register_basic_auth(httpd_handle_t server) {
    ...
    if (basic_auth_info) {
        ...
        basic_auth_info->password = "123456";
...
void app_main(void) {
    ...
    memcpy(wifi_config.sta.password, CONFIG_WIFI_PASSWD,
           sizeof(CONFIG_WIFI_PASSWD));
